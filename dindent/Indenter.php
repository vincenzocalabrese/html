...
class Indenter {
	private
			...
			$inline_elements = array('col', 'b', 'big', 'i', 'small', 'tt', 'abbr', 'acronym', 'cite', 'code', 'dfn', 'em', 'kbd', 'strong', 'samp', 'var', 'a', 'bdo', 'br', 'img', 'span', 'sub', 'sup'),
		...
		do {
			...
			$patterns = array(
				...
				// self closing SVG tags
					'/^<(animate|stop|path|circle|line|polyline|rect|use|col)([^>]*)\/>/' => static::MATCH_INDENT_NO,
				// opening tag
